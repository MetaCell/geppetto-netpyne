  ...
  render () {
    ...
    return <div>
      ...
      >
        ...
        <ListItem id="appBarNew" onClick={() => this.handleListItemClick('NewModel')} >
          <ListItemIcon><FontIcon color="primary" className='fa fa-plus' /></ListItemIcon>
          <ListItemText primary="New" />
        </ListItem>
        <ListItem id="appBarOpen" onClick={() => this.handleListItemClick('Load')} >
          <ListItemIcon><FontIcon color="primary" className='fa fa-folder-open-o' /></ListItemIcon>
          <ListItemText primary="Open..." />
        </ListItem>
        <ListItem id="appBarSave" onClick={() => this.handleListItemClick('Save')} >
          <ListItemIcon><FontIcon color="primary" className='fa fa-download' /></ListItemIcon>
          <ListItemText primary="Save As..." />
        </ListItem>
        <ListItem id="appBarImportHLS" onClick={() => this.handleListItemClick('ImportHLS')} >
          <ListItemIcon><ImportIcon color="primary" /></ListItemIcon>
          <ListItemText primary="Import.." />.</ListItem>
        <ListItem id="appBarExportHLS" onClick={() => this.handleListItemClick('ExportHLS')} >
          <ListItemIcon><ExportIcon color="primary" /></ListItemIcon>
          <ListItemText primary="Export..." /></ListItem>
        <ListItem id="appBarImportCellTemplate" onClick={() => this.handleListItemClick('ImportCellTemplate')} >
