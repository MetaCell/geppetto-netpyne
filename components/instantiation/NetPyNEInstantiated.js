...
import Canvas from 'webapp/js/components/interface/3dCanvas/Canvas';
import ControlPanel from 'webapp/js/components/interface/controlPanel/controlpanel';
import IconButton from 'webapp/js/components/controls/iconButton/IconButton';
