...
export default class OneDimRange extends Component {
  ...
  updateLayout() {
    ...
    if (this.props.conds) message = message + "['conds']";
  ...
  render() {
    if (this.props.conds) {
      var meta = this.props.model + '.conds.' + this.props.items[0].value;
      var path = this.props.model + "['" + this.state.currentName + "']['conds']['" + this.state.rangeType + "']";
    } else {
