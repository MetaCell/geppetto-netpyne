  ...
  render() {
    ...
    if (this.state.page == 'main') {
      ...
      if (this.state.selectedStimulationSource && Object.keys(model).indexOf(this.state.selectedStimulationSource)>-1) {
        selectedStimulationSource = <NetPyNEStimulationSource name={this.state.selectedStimulationSource} model={this.state.value[this.state.selectedStimulationSource]}/>;
      }
